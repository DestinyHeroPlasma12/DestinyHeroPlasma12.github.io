// gsap.from('.art-image', { duration: 3, y: '-100%', ease: 'bounce'})
//gsap.from('.art', { duration: 30, opacity: 0, delay: 0, stagger: .5 })
//gsap.from('.art2', { duration: 30, opacity: 0, delay: 0, stagger: .5 })
...
const timeline = gsap.timeline({ defaults: { duration: 3.5 }})
timeline
